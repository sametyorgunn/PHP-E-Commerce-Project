 ...
 <?php include '../include/header.php'; ?>
        ...
        <?php if (isset($_POST['sayfa_insert'])) {
    
        $sonuc=$db->insert("sayfa",$_POST,
        ["form_name" => "sayfa_insert",
        "slug" => "sayfa_slug",
        "title" => "baslik"]);
        ...
        <button type="submit" class="btn btn-success" name="sayfa_insert"> <i class="ti-plus"></i> Kaydet</button>
        ...
        <?php }  else if (isset($_GET['sayfaUpdate'])) { ?>
        ...
        <?php 
        if (isset($_POST['sayfa_update'])) {
    
        $sonuc=$db->update("sayfa",$_POST,
        ["form_name" => "sayfa_update",
        "columns" => "id",]);
        ...
        <div class="form-actions">
        <button type="submit" class="btn btn-success" name="sayfa_update"> <i class="ti-plus"></i> Kaydet</button>
        <a href="javascript:javascript:history.go(-1)" class="btn btn-danger">İptal Et</a>
        </div>
        ...
        <h4 class="text-themecolor">Sayfalar</h4>
        </div>
        ...
        <a href="?sayfaInsert=true">
        <button type="button" class="btn btn-info d-none d-lg-block m-l-15">
        <i class="ti-angle-double-right"></i> Sayfa Ekle</button></a>
        </div>
        </div>
        </div>
        ...
        <?php
        if (isset($_GET['sayfaDelete'])) {

        $sonuc=$db->delete("sayfa","id",$_GET['id']);
        ...
        <td>
        <center>
        <a href="?sayfaUpdate=true&id=<?php echo $row['id'] ?>">
        <button type="button" class="btn btn-sm btn-success"><i class="ti-pencil-alt"></i></button></a>

        <a href="?sayfaDelete=true&id=<?php echo $row['id'] ?>">
