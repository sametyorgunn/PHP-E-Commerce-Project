        ...
        <div class="col-12 col-md-6 login-form mt__60 mb-0 mb-md-5">
            ...
            if (isset($_POST['uyepanel'])) {
                ...
                if ($row && $row2) {
                    ...
                    setcookie("uyeolmayan", "", time()-3600);
        ...
        <button class="btn btn-primary btn-sm" type="submit" name="uyepanel">Giriş Yap</button> 
        <a href="odeme" class="btn btn-danger btn-sm" type="submit" name="uyepanel">Üyeliksiz Devam Et</a>
        </div>
        </form>
