  ...
  <title> Arama Sonuçları</title>
    ...
    <div class="kalles-section page_section_heading">
        <div class="page-head tc pr oh cat_bg_img page_head_">
                <div class="parallax-inner nt_parallax_false lazyload nt_bg_lz pa t__0 l__0 r__0 b__0" data-bgset="images/banner/">
            ...
            <div class="cat_sortby cat_sortby_js col tr kalles_dropdown kalles_dropdown_container">
                ...
                <div class="nt_sortby dn">
                    ...
                    <div class="nt_ajaxsortby wrap_sortby kalles_dropdown_options">
                        <a data-label="Price, low to high" class="kalles_dropdown_option truncate" href="#">Düşükten Yükseğe Sırala</a>
                        <a data-label="Price, high to low" class="kalles_dropdown_option truncate" href="#">Yüksekten, Düşüğe Sırala</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-12">
                <div class="kalles-section tp_se_cdt">
                    ...
                    <div class="on_list_view_false products nt_products_holder row fl_center row_pr_1 cdt_des_1 round_cd_false nt_cover ratio_nt position_8 space_30 nt_default">
                        ...
                        <?php
                        $aranakelime = $_SESSION["aranankelime"];
                        $sql=$db->db_select2("SELECT * FROM urun WHERE durum = ? AND urun_ad LIKE '%$aranakelime%'",[1]);
                        foreach ($sql as $urunn) {  ?>
                            ...
                            <div class="col-lg-3 col-md-3 col-6 pr_animated done mt__30 pr_grid_item pr_list_item product nt_pr desgin__1">
                                <div class="product-inner pr">
                                    ...
                                    <div class="product-image pr oh lazyload">
                                        <?php if($urunn['indirimyuzdeorani']==0 || $urunn['indirimyuzdeorani']==null )
                                        {?>

                                        <?php } else { ?>
                                            <span class="tc nt_labels pa pe_none cw"><span class="onsale nt_label"><span>-<?=$urunn['indirimyuzdeorani']?>%</span></span></span>

                                        <?php } ?>
                                        <a class="db" href="Urundetay/<?php echo $db->seo($urunn['urun_ad']); ?>?id=<?php echo $urunn['id'] ?>">
                                            <div class="pr_lazy_img main-img nt_img_ratio nt_bg_lz lazyload padding-top__100"
                                                 data-bgset="images/urun/<?=$urunn['resim']?>"></div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="product-info">
                                        <div class="product-info__inner">
                                            <h3 class="product-title pr fs__14 mg__0 fwm">
                                                <a class="cd chp" href="Urundetay/<?php echo $db->seo($urunn['urun_ad']); ?>?id=<?php echo $urunn['id'] ?>"><?=$urunn['urun_ad']?></a> </h3>

                                            <span class="price dib mb__5"><del><span class="money"><?=$urunn['fiyat']?> TL</span></del>
                                               <ins><span class="money"><?=$urunn['indirimlifiyat']?> TL</span></ins></span>

                                            <div class="rte dn">
                                                <p class="mb__5"><?=$urunn['altozet']?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
